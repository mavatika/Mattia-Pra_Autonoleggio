...
$page->putDynamicContent([
  'common_user' => !$user->loggedIn && isset($_SESSION['temp_user_back']) && $_SESSION['temp_user_back'] === true ? '<p class="common_user">It seems that you use our service so often, why don\'t you <a href="../user/signup.php" class="link bold">create an account?</a></p>' : '',
  'error' => ''
]);
